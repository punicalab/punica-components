    ...
    <Layout.Main>
      ...
      <Layout.Content>
        <punica-row spacing={2}>
          ...
          <punica-col xs={12}>
            <punica-typography variant="headline2" text-align="center">
              headline2 center
            </punica-typography>
          </punica-col>
          <punica-col xs={12}>
          ...
          <punica-col xs={12}>
            <punica-typography variant="body1" text-align="center">
              body1 center
            </punica-typography>
          </punica-col>
          <punica-col xs={12}>
            <punica-typography variant="body1" font-weight="extra-bold">
              body1 extra-bold
            </punica-typography>
          </punica-col>
          <punica-col xs={12}>
